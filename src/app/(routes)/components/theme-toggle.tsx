...
export default function ThemeToggle() {
    ...
    return (
        <div className={cn("border flex gap-1 bg-secondary rounded-full")}>
            <Button 
                size={"sm"} 
                variant="secondary" 
                className={cn(theme === "light" ? "bg-background": "", "rounded-full hover:bg-background duration-700 hover:text-main-color")}
