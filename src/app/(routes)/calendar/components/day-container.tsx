        ...
        >
            ...
            <Paragraph>
              {
                days[
                  dayjs(
                    new Date(year, monthIndex, currentDay.getDay()),
                  ).day() || 0
                ]
              }
            </Paragraph>
          ...
          <div
            className={cn(
              ...
              isToday(
                dayjs(new Date(year, monthIndex, currentDay.getDate())).format(
                  "DD MMM, YYYY",
                ),
              )
        ...
        {hours.map((hour) => (
          <div key={hour} className="flex border-b h-[100px]">
            ...
            <div
              ...
              onClick={() => {
                let isPast = dayjs(new Date(year, monthIndex, day)).isBefore(
                  dayjs(),
                );
                if (isPast) {
                  createToast(
...
const HourEvents = ({
  ...
  return <Events events={hourEvents} />;
};
