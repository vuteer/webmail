...
interface ImageUploadProps {
  setFiles: React.Dispatch<string[]>;
  files: string[];
  isOpen: boolean;
  onClose: () => void;
}
...
const ImageUploadModal: React.FC<ImageUploadProps> = ({
  ...
  const uploadFileToServer = async (formData: any, onUploadProgress: any, cancelSource: any) => {
    return axios.post('YOUR_CUSTOM_SERVER_URL/upload', formData, {
      onUploadProgress,
      cancelToken: cancelSource.token,
    });
  };
