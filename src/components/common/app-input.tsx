...
export const resetClass =
  "bg-transparent border-none text-sm lg:text-md focus:outline-none focus-visible:ring-0 focus-visible:ring-offset-0";
...
const AppInput: React.FC<InputProps> = ({
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "bg-secondary flex items-center gap-1 px-2 py-[.02rem] pr-[.02rem] border-[.01rem] rounded-lg overflow-hidden",
          containerClassName,
          active ? "border-main-color" : "border-transparent",
        )}
      >
        {icon && icon}
        {textarea ? (
