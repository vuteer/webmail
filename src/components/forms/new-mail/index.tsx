...
import { Attachments, ReplyButtons, } from '@/app/(routes)/(home)/components/reply';
...
const NewMailForm = () => {
  ...
  return (
    <TooltipProvider delayDuration={0}>
      <div className="p-4 flex flex-col gap-4 w-full h-full overflow-auto">
...
export const InputPair = (
  { label, value, placeholder, setValue, error, type, onKeyUp, prefixes, disabled }:
    {
      label?: string,
      placeholder: string,
      value: string,
